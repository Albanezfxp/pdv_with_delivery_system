...
public class OrderController {
    ...
    public ResponseEntity<Page<OrderEntity>> getAllOrdersFromDelivery(
            ...
            @RequestParam(value = "directionParam", defaultValue = "createdAt") String directionParam
    ) {
        ...
        Pageable pageable = PageRequest.of(page, size, Sort.by(sorDirection, directionParam));
